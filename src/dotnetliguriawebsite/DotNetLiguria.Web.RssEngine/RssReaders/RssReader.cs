...
namespace DotNetLiguria.Web.RssEngine.RssReaders
{
    ...
    internal class RssReader : BaseRssReader
    {
        ...
        private static RssSchema ParseItem(XElement item)
        {
            ...
            string content = item.GetSafeElementString("encoded", NsConentNamespaceUri);
            ...
            rssItem.Content = string.IsNullOrEmpty(content) ? RssHelper.SanitizeString(description) : content;
