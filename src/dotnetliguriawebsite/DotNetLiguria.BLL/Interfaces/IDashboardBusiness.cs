...
namespace DotNetLiguria.BLL.Interfaces
{
    public interface IDashboardBusiness
    {
        ...
        void WorkshopTrack_Update(WorkshopTrackViewModel model, Guid[] Speakers);
        ...
        List<OffertaLavoro> OfferteLavoro_GetList();
        OffertaLavoro OfferteLavoro_Get(System.Guid offerteLavoroId);
        void OfferteLavoro_Create(OffertaLavoro model, CustomUser user);
        void OfferteLavoro_Delete(System.Guid offerteLavoroId);
        void OfferteLavoro_EnableDisable(System.Guid offerteLavoroId);
        void OfferteLavoro_Update(OffertaLavoro model);
